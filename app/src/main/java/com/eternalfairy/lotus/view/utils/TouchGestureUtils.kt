...
//            clockEnd,
    ...
    fun formatTime(minutesTotal: Int): String {
        var hours = minutesTotal / com.eternalfairy.lotus.view.component.MINUTES_IN_HOUR
        var minutes = 0

        if (minutesTotal % com.eternalfairy.lotus.view.component.MINUTES_IN_HOUR != 0) {
            hours = floor(hours.toDouble()).toInt()
            minutes = minutesTotal - hours * com.eternalfairy.lotus.view.component.MINUTES_IN_HOUR
        }
