...
//        if (time.compareTo(activeTimeEnd) == 0) return 360f
    ...
    fun formatTime(minutesTotal: Int): String {
        var hours = minutesTotal / com.eternalfairy.timeaware.ui.component.MINUTES_IN_HOUR
        var minutes = 0

        if (minutesTotal % com.eternalfairy.timeaware.ui.component.MINUTES_IN_HOUR != 0) {
            hours = floor(hours.toDouble()).toInt()
            minutes = minutesTotal - hours * com.eternalfairy.timeaware.ui.component.MINUTES_IN_HOUR
        }
